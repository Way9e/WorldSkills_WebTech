...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE marca SET descMarca='$descMarca' WHERE idMarca=$idMarca";
...
<body>
    ...
    <label>Id Marca:</label>
        <input type="texto" name="idMarca" value="<?= $linha['idMarca']; ?>" readonly><br/>
    <label>Marca:</label>
        <input type="text" name="descMarca" value="<?= $linha['descMarca']; ?>" required><br/>
