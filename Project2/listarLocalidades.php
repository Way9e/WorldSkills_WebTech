...
<meta charset="UTF-8">
    ...
    <title>Gestão de Localidades</title>
...
<body>
    ...
    <h2>Localidades</h2>
    <a class="insert" href="inserirLocalidade.php">Adicionar Localidade</a><br/><br/>
    <table cellspacing="0" cellpadding="10">
        ...
        <tr>
            <td><?= $row['idLocalidade']; ?></td>
            <td><?= $row['descLocal']; ?></td>
            <td>
                <a href="editarLocalidade.php?idLocalidade=<?= $row['idLocalidade']; ?>">Editar</a>
                <a href="apagarLocalidade.php?idLocalidade=<?= $row['idLocalidade']; ?>" onclick="return confirm('Tem a certeza que deseja apagar')">Apagar</a>
            </td>
        </tr>
        <?php } ?>
    </table>
