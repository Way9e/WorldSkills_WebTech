...
$sql = "SELECT idUtilizador, login, foto, categoria FROM utilizador INNER JOIN categoria ON utilizador.idCategoria=categoria.idCategoria";
...
<body>
    ...
    <h2>Utilizadores</h2>
    <a class="insert" href="inserirUser.php">Adicionar Utilizador</a><br/><br/>
    <table cellspacing="0" cellpadding="10">
        ...
        <tr>
            ...
            <td><?= $row['categoria']; ?></td>
            <td>
                <a href="editarUser.php?idUtilizador=<?= $row['idUtilizador']; ?>">Editar</a>
                <a href="apagarUser.php?idUtilizador=<?= $row['idUtilizador']; ?>" onclick="return confirm('Tem a certeza que deseja apagar?')">Apagar</a>
            </td>
        </tr>
        <?php } ?>
    </table>
