...
<body>
    ...
    <h2>Marcas</h2>
    <a class="insert" href="inserirMarca.php">Adicionar Marcas</a><br/><br/>
    <table cellspacing="0" cellpadding="10">
        ...
        <tr>
            ...
            <td><?= $row['descMarca']; ?></td>
            <td>
                <a href="editarMarca.php?idMarca=<?= $row['idMarca']; ?>">Editar</a>
                <a href="apagarMarca.php?idMarca=<?= $row['idMarca']; ?>" onclick="return confirm('Tem a certeza que deseja apagar?')">Apagar</a>
            </td>
        </tr>
        <?php } ?>
    </table>
